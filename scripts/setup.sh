...
echo ""
echo -e "  后续常用命令（在 vinnfeng/opencode 克隆目录的 scripts/ 下运行）："
echo -e "    ${BLUE}./setup.sh --keys${RESET}      # 更新所有 key"
echo -e "    ${BLUE}./setup.sh --key mify${RESET}  # 只换 Mify key"
echo -e "    ${BLUE}./setup.sh --binary${RESET}    # 只更新二进制"
echo -e "    ${BLUE}./setup.sh --rollback${RESET}  # 回退上一版本"
echo -e ""
echo -e "${BOLD}═══════════════════════════════════════════════${RESET}"
echo ""
